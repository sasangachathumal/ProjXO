 ...
 */
const addProject = ({ name, path, type, ide = null }) => {
 ...
 */
const getAllProjects = ({ bookmarkedOnly = false, type = null } = {}) => {
  const data = readProjects();
 ...
 */
const getRecentProjects = (limit = 10) => {
  const data = readProjects();
